...
import { TimerStateValue } from "../../../services/reducers/timer-reducer";
import {
  Todo,
  ActionTypeValue,
} from "../../../services/reducers/todos-reducer";
import {
  useTimer,
  useTimerDuration,
  useTodos,
...
export function TodosContainer() {
  ...
  function onSelected(todoGuid: string) {
    if (timerState.currentState != TimerStateValue.Stopped) {
      return;
    }
